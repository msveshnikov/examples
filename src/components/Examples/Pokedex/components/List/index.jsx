        ...
        <>
            <Container maxWidth="lg">
                <Paper className={classes.options}>
                    <Button color="primary" variant="contained" onClick={fetchAll}>
                        Catch
                    </Button>
                    <Button color="primary" variant="contained" onClick={resetData}>
                        Reset
                    </Button>
                    <Typography>{<span>Catched in: {timer ? timer : "..."} ms</span>}</Typography>
                </Paper>
            </Container>
            <Container maxWidth="lg" className={classes.container}>
                ...
                {filteredPokemons.map((pokemon, i) => (
                    <PreviewCard key={pokemon.name} pokemon={pokemon}></PreviewCard>
                ))}
            </Container>
        </>
    );
