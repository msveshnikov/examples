    ...
    canDrop(props, monitor, component) {
        ...
        if (destination === Places.FOUNDATION) {
            return (
                ...
                ((draggedCard.where[0] === Places.PILE && draggedCard.isLast) || draggedCard.where[0] === Places.DECK)
            );
...
class DraggableCard extends React.Component {
    ...
    moveCard = (card) => {
        ...
        dispatch(ActionCreators.moveCard([card], { from: card.where, to: this.props.where }));
    };
...
export default connect((state) => state)(
    DragSource(
        ...
        cardSource,
        collectDrag
    )(DropTarget("DraggableCard", cardTarget, collectDrop)(DraggableCard))
);
